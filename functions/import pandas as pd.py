...
class NBA_Player():
    def __init__(self, name):
        ...
        self.nextgame = PlayerNextNGames(number_of_games=5, player_id=self.players_ID)
        self.df = self.nextgame.get_data_frames()[0]
        self.game_List = []
...
# usage 
Kawhi_Leonard = NBA_Player("Kawhi Leonard")
